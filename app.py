...
def show_intro():
    ...
    if st.button("Start Experiment"):
        ...
        # Immediately update the DB so it now reflects "demo"
        supabase.table('sessions').update({
            'current_page': 'demo',
            'current_trial': st.session_state.trial,
            'current_trial_step': st.session_state.trial_step
...
def show_demo_initial():
    ...
    st.markdown("<div style='color: red; margin-bottom: 20px;'>This is a demonstration of the initial allocation step. Try adjusting the slider to see how allocations work.</div>", 
...
def show_demo_ai():
    ...
    st.markdown("<div style='color: red; margin-bottom: 20px;'>This demonstrates the AI recommendation step. The AI suggestion here is randomly generated.</div>", 
                unsafe_allow_html=True)
...
def show_demo_performance():
    ...
    st.markdown("<div style='color: red; margin-bottom: 20px;'>This shows performance results. Returns are randomly generated for demonstration.</div>", 
                unsafe_allow_html=True)
    ...
    ai_return = (st.session_state.demo_data['ai_a']/100)*return_a + (st.session_state.demo_data['ai_b']/100)*return_b
    ...
    fig.update_layout(yaxis_title='Performance (%)', showlegend=False)
